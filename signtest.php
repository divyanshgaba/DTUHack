...
?>
 ...
 <body >
    ...
    <header id="header-wrap">
        ...
        <div class="container">
          <h1>
           <center> <i>Patient Dashboard</i></center>
          </h1>
        </div>
...
?>
<div class="col-sm-6"> 
<img src="icon/people.png" height="400" width="300"></img>
<?php
$pid=17;
$sql="select * from patient where id='$pid'";
$res=mysql_query($sql);
while($result=mysql_fetch_array($res)){
	echo '<p><font style="font-size:35px;"><b>Name: </b></font><font style="font-size:35px;">'.ucfirst($result['name']).'</font></p></br>';
	echo '<p>Phone: '.$result['phone'].'</p></br>';
	echo '<p>Email: '.$result['email'].'</p></br>';
	echo '<p>Gender: '.$result['gender'].'</p></br>';
	echo '<p>Address: '.$result['address'].'</p></br>';
}
